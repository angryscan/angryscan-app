-- Test data for ConnectorCockroachDBIntegrationTest
...
INSERT INTO employees (full_name, email, phone, passport, snils, inn, card_number, address, oms, vehicle_reg, login,
                       password_hash)
VALUES ('Анатолий Анатольевич Анатоль', 'test@gmail.com', '88005553535', '4132 234231', '87647163459', '732557279170',
        '4276 8070 1492 7948', 'г. Санкт-Петербург, пр. Бульварный, д. 4 стр. 86', '7750900873002404', 'в404сх 99',
        'Voldemort643s', 'assword432'),
       ('Иванов Анатолий Анатольевич', 'test2@gmail.com', '88005555353', '4131 234232', NULL, NULL, NULL, NULL, NULL,
        NULL, NULL, NULL),
       ('Смирнов Анатолий Анатольевич', 'test@gmail.com', '88005553535', '4132 234231', '87647163459', '732557279170',
        '4276 8070 1492 7948', 'г. Санкт-Петербург, пр. Бульварный, д. 4 стр. 86', '7750900873002404', 'в404сх799',
        'Voldemort643s', 'assword432'),
       ('Козлов Дмитрий Петрович', 'kozlov.dp@yandex.ru', '+79161234567', '4501 987654', '126 029 036 24',
        '772459534170', '4303 8013 0890 0569', 'г. Москва, ул. Ленина, д. 10', NULL, NULL, NULL, NULL),
       ('Новикова Елена Васильевна', 'novikova@mail.ru', '+79035551234', '4510 112233', '162-834-652 79',
        '771907341008', '4662 9949 5547 2514', 'г. Новосибирск, ул. Красный проспект, д. 50', NULL, NULL, NULL, NULL),
       ('Морозов Алексей Игоревич', 'morozov.ai@inbox.ru', '+74951234567', '4515 445566', '187-220-276-69',
        '772403587357', '4298 4987 4439 0799', 'г. Екатеринбург, ул. Мира, д. 25 кв. 3', NULL, NULL, NULL, NULL),
       ('Волкова Ольга Николаевна', 'volkova@company.com', '+78126543210', '4520 778899', '057 033 028 27',
        '771871997347', '4468 2727 8411 6362', 'г. Казань, ул. Баумана, д. 15', NULL, NULL, NULL, NULL),
       ('Соловьёв Михаил Александрович', 'solovev@test.org', '+79997776655', '4525 334455', '13378907489',
        '771822622916', '4861 0368 6714 3293', 'г. Самара, ул. Победы, д. 100', NULL, NULL, NULL, NULL),
       ('Васильева Анна Дмитриевна', 'vasileva.ad@gmail.com', '+79261112233', '4530 667788', '152232898 47',
        '583410778676', '4583984644874606', 'г. Краснодар, ул. Северная, д. 7', '7755320882002755', NULL, NULL, NULL),
       ('Зайцев Сергей Владимирович', 'zaytsev@proton.me', '+79031239876', '4535 990011', '199-510-399 13', NULL,
        '1234432112344321', 'г. Ростов-на-Дону, пр. Ворошиловский, д. 33', NULL, NULL, NULL, NULL),
       ('Иванов Иван Иванович', 'ivanov@example.com', '+79001234567', '1213 141516', NULL, '849600020355', NULL,
...
INSERT INTO network_logs (source_ip, destination_ip, log_message)
VALUES ('192.168.1.1', '10.31.129.98', 'Internal traffic detected'),
...
INSERT INTO payments (cardholder_name, card_number, account_number, cvv, amount)
VALUES ('Анатоль А.А.', '4276 8070 1492 7948', '40802810335300540583', '435', 15000.50),
...
SELECT TIMESTAMP '2022-11-07 20:23:04' + (i || ' seconds')::interval,
       '00001A50',
       '000024BC',
       '+79123455667',
...
INSERT INTO citizens_ru (full_name, birthday, driver_license, military_id, ogrnip, okpo, osago_policy, sberbook,
                         cadastral_number, state_reg_contract, legal_entity_id, legal_entity_name, notes)
VALUES ('Иванов Иван Иванович', '1990-05-15', '77 14 567890', 'АБ 1234567', '312774600000012', '12345678',
       ...
       ('Петрова Мария Сергеевна', '1985-12-03', '50 22 123456', NULL, '315503400000045', '98765432', 'ЕЕЕ 9876543210',
        '42307810200000098765', '50:03:0004567:89', '50-50/002-50/002/002/2021-5678', '1035000567890', 'ООО "Василёк"',
        'Дата рождения: 03.12.1985'),
       ('Сидоров Алексей Петрович', '1978-03-22', '99 08 345678', 'ВГ 7654321', '316770100000078', '45678901',
       ...
       ('Кузнецова Елена Александровна', '1995-07-10', '78 15 901234', NULL, '318784700000034', '23456789', NULL,
        '42307810400000023456', '78:06:0001122:34', NULL, '1027800987654', 'ИП Кузнецова Е.А.',
        'Дата рождения: 10.07.1995'),
       ('Попов Дмитрий Николаевич', '1982-11-28', '39 03 567891', 'ДЕ 9876543', '312390300000056', '67890123',
...
VALUES ('John Michael Smith', '123-45-6789', '12-3456789', '912-34-5678', '021000021', 'D123-4567-8901', 'C12345678',
       ...
       ('Ashley Nicole Taylor', '789-01-2345', '78-9012345', '919-78-9012', '021808070', 'T789-0123-4567', 'C78901234',
        '+1 (555) 789-0123', '258 Spruce St, Boston, MA 02101', '8LN1-AL2-TR49', 'H78901234', 'A789012345',
        'MSC7890123456', 'N0078901234', '1234567968'),
       ('Christopher Lee Anderson', '890-12-3456', '89-0123456', '920-89-0123', '021909090', 'A890-1234-5678',
       ...
       ('Amanda Joy Thomas', '901-23-4567', '90-1234567', '921-90-1234', '022000013', 'T901-2345-6789', 'C90123456',
        '+1 (555) 901-2345', '480 Chestnut Way, Atlanta, GA 30301', '0NP3-CN4-VT61', 'J90123456', 'A901234567',
        'MSC9012345678', 'N0090123456', '1234567984'),
       ('Daniel Patrick Jackson', '012-34-5678', '01-2345678', '922-01-2345', '022100003', 'J012-3456-7890',
       ...
       ('Megan Claire White', '135-79-2468', '13-5792468', '923-13-5792', '022200041', 'W135-7924-6801', 'C13579246',
        '+1 (555) 135-7924', '702 Aspen Rd, Nashville, TN 37201', '2PR5-EP6-XV83', 'L13579246', 'A135792468',
        'MSC1357924680', 'N0013579246', '1234568008'),
       ('William Edward Harris', '246-80-1357', '24-6801357', '924-24-6801', '022300056', 'H246-8013-5790', 'C24680135',
       ...
       ('Lauren Elizabeth Martin', '357-91-2460', '35-7912460', '925-35-7912', '022400068', 'M357-9124-6080',
       ...
       ('James Richard Garcia', '468-02-3571', '46-8023571', '926-46-8023', '022500072', 'G468-0235-7190', 'C46802357',
...
INSERT INTO vehicles_crypto (vin, crypto_wallet, seed_phrase, hash_value, hash_type)
VALUES ('WBA3A5C55CF256789', '1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa',
        'abandon ability able about above absent absorb abstract absurd abuse access accident',
        '5d41402abc4b2a76b9719d911017c592', 'MD5'),
       ('1HGBH41JXMN109186', '0x742d35Cc6634C0532925a3b844Bc9e7595f2bD18',
       ...
       ('JTDKN3DU8A0123456', '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48',
       ...
       ('1G1YY22G965123456', '0x6B175474E89094C44Da98b954EedeAC495271d0F',
        'artist beacon crystal dolphin ember falcon glacier harbor ignite jester knapsack lantern',
        'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855', 'SHA-256'),
       ('2T1KR32E94C123456', '1BoatSLRHtKNngkdXEeobR76b53LETtpyT',
       ...
       ('WVWZZZ3CZWE789012', 'rPfV8ykdPpsFeSmxZoEi4dCEFmXiVvfy3C',
       ...
       ('3VWFE21C04M123456', '0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984', NULL,
