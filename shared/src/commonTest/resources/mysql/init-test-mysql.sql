-- Test data for ConnectorMySQLIntegrationTest
...
SELECT
    CONCAT('user', n, '@mail.ru'),
    CONCAT('+7927572', LPAD(CAST(n AS CHAR), 4, '0')),
    TIMESTAMPADD(MINUTE, n, TIMESTAMP('2022-01-01 00:00:00'))
FROM seq;
...
SELECT
    TIMESTAMPADD(SECOND, n, TIMESTAMP('2022-11-07 20:23:04')),
    '00001A50',
    '000024BC',
    '+79123455667',
    CONCAT('CFG: Check DB integrity... Element (idx=', MOD(n, 100), ') processed')
FROM seq;
...
SELECT
    ...
    CONCAT(
        ...
        'Contact: user', n, '@example.com, INN: 7724', LPAD(CAST(n AS CHAR), 8, '0')
    ),
    CONCAT('user', n, '@example.com'),
    CONCAT('7724', LPAD(CAST(n AS CHAR), 8, '0'))
FROM seq;
