...
private val matcherResources: Map<KClass<out IMatcher>, Pair<StringResource, StringResource>> = buildMap {
    ...
    put(RIN::class, Res.string.Matcher_RIN to Res.string.Matcher_Description_RIN)
    put(FullName::class, Res.string.Matcher_Name to Res.string.Matcher_Description_Name)
    put(FullNameUS::class, Res.string.Matcher_FullNameUS to Res.string.Matcher_Description_FullNameUS)
    ...
    put(Certificate::class, Res.string.Matcher_Certificate to Res.string.Matcher_Description_Certificate)
    put(MedicareUS::class, Res.string.Matcher_MedicareUS to Res.string.Matcher_Description_MedicareUS)
    ...
    put(PassportUS::class, Res.string.Matcher_PassportUS to Res.string.Matcher_Description_PassportUS)
    ...
    put(PhoneUS::class, Res.string.Matcher_PhoneUS to Res.string.Matcher_Description_PhoneUS)
    ...
    put(SSN::class, Res.string.Matcher_SSN to Res.string.Matcher_Description_SSN)
