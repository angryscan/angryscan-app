...
object MatcherCountryMapping {
    private val countryMap: Map<KClass<out IMatcher>, MatcherCountry> = mapOf(
        ...
        TemporaryID::class to MatcherCountry.RUSSIA,
        ...
        BirthCert::class to MatcherCountry.RUSSIA,
        ...
        InheritanceDoc::class to MatcherCountry.RUSSIA,
        MaritalStatus::class to MatcherCountry.RUSSIA,
        MarriageCert::class to MatcherCountry.RUSSIA,
        ...
        UidContractBankBki::class to MatcherCountry.RUSSIA,
